...
private:
    ...
    // Helper function to create simple movement patterns
    MovementPattern createMovementPattern(const glm::vec3& center, size_t index, size_t totalCount) {
        MovementPattern pattern;
        pattern.type = MovementType::Petal;
...
public:
    ...
    // Create a single entity with simple petal movement pattern
    Entity createMovingEntity(const glm::vec3& pos, Renderable::ShapeType shape = Renderable::ShapeType::Triangle) {
        ...
        MovementPattern pattern = createMovementPattern(pos, 0, 1);
    ...
    // Create swarm of entities with simple petal movement patterns
    std::vector<Entity> createSwarm(size_t count, const glm::vec3& center, float radius) {
        ...
        return createBatch(count, [&](EntityBuilder& builder, size_t i) {
            ...
            // Create simple petal movement pattern
            MovementPattern pattern = createMovementPattern(pos, i, count);
