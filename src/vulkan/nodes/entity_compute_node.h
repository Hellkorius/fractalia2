...
class EntityComputeNode : public BaseComputeNode {
...
protected:
    ...
    const char* getNodeName() const override { return "EntityComputeNode"; }
    const char* getDispatchBaseName() const override { return "EntityMovement"; }
};