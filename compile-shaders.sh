...
# Compile vertex unified shader
glslangValidator -V src/shaders/vertex_unified.vert -o src/shaders/compiled/vertex_unified.spv
cp src/shaders/compiled/vertex_unified.spv build/shaders/compiled/
